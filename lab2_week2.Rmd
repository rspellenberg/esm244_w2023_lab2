...
#same model as we had before, just a cleaner way to write it
...
# compare models using kfold cross validation
```{r}
folds <- 10
...
for(i in 1:folds) {
  ...
  #can use a . when using the same data frame as the one we start with in the tidyverse
